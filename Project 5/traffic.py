...
def load_data(data_dir):
    ...
    print(f"Trying to load from directory: {data_dir}")
    ...
    for category in range(NUM_CATEGORIES):
        ...
        if os.path.isdir(category_directory):
            print(f"Loading category {category} from {category_directory}")
            ...
            print(f"Warning: Directory not found: {category_directory}")
